        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">Add subfamily</a>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr>
                                    ...
                                    <th class="border-bottom-0"> subfamily name</th>
                        ...
                        <tbody>
                                ...
                                @foreach ($sub_familys as $sub_family)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $sub_family->locality_families->LocalFamily }}</td>
                                        <td>
                                            
                                                <button class="btn btn-outline-success btn-sm"
                                                    data-name="{{ $sub_family->SubFamily }}" data-pro_id="{{ $sub_family->SubFamilyCode }}"
                                                    data-section_name="{{ sub_family->locality_families->LocalFamily  }}"
                                                     data-toggle="modal"
                                                    data-target="#edit_Product">تعديل</button>
                                           

                                            
                                                <button class="btn btn-outline-danger btn-sm " data-pro_id="{{ $sub_family->SubFamilyCode }}"
                                                    data-product_name="{{ $sub_family->SubFamily }}" data-toggle="modal"
