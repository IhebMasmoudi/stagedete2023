					...
					<table id="example" class="table key-buttons text-md-nowrap">
						...
						<tbody>
							...
							<tr>
								...
								<td> <button class="btn btn-outline-success btn-sm edit-button" data-toggle="modal" data-target="#edit_counter">
										Edit
									</button>


									<button class="btn btn-outline-danger btn-sm delete-button" data-toggle="modal" data-target="#modaldemo9">
										Delete
									</button>
								</td>
								<td></td>
