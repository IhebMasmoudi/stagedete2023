						...
						<div class="card mg-b-20">
							...
							<div class="card-body">
								<div class="table-responsive">
                                    ...
                                    data-id="{{ $x->id }}" data-section_name="{{ $x->district_name }}"
    data-description="{{ $x->description }}" data-toggle="modal"
   href="#exampleModal2" title="edit">edit<i class="las la-pen"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('districts.store') }}" method="post" autocomplete="off">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
                    <div class="form-group">
                        <input type="hidden" name="id" id="edit_id" value="">
                        <label for="section_name" class="col-form-label">District name</label>
                        <input class="form-control" name="section_name" id="edit_section_name" type="text">
                    </div>
                    <div class="form-group">
